...
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ...
  (
<<<<<<< HEAD:src/server/database/dbInit.sql
...
>>>>>>> 2c8244a0e20a5d9abcbe8dfb32c806650b05473c:src/server/database/dbInitializer.sql
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/hInP/50490A.jpg',1000, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/JCb2/50506A.jpg',1200, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/MRlS/50510AL.jpg',1500, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/n2cm/50514AL.jpg',1260, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/qfO9/50515AL.jpg',960, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/rIo5/50516AL.jpg',2000, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  ),
  (
    'Empire dress', 'https://files.gitter.im/MarwaBj/qiUW/50535AL.jpg',1230, 'USD', 'Gaza', 'zaghroota.fashion', '
Dress tight down the chest rotation and drop down after chest wide down', 'XL', 'dresses', 4
  );
